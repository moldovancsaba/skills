...
function buildRecommendationPrompts(company, flashcards, focusTopics = [], feedbackContext = {}, options = {}) {
  ...
  const systemPrompt = [
    ...
    "impact and ease are integers from 1 to 10. confidence is an integer from 1 to 100.",
    "sourceFlashcardRefs is an array of integer refs from the provided flashcards.",
    "GROUNDING RULE: Every task must be a direct logical consequence of at least one provided flashcard. If a task could apply to any company in this industry without reading these specific flashcards, it is too generic—DELETE IT.",
    "EXCLUSION RULE: No 'generic advice' (e.g., 'optimize website', 'post more on LinkedIn') unless the flashcard provides a specific data point, error, or finding that justifies it.",
