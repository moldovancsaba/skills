...
const translations = {
  en: {
    ...
    settings: {
      ...
      bridgeDescription: "Use this key to send data into checklist memory from external scripts.",
  ...
  ar: {
    ...
    nav: { company: "وحدة الاستخبارات", companyDescription: "وحدة تشغيل", companySyncing: "جارٍ المزامنة...", selectPortfolio: "اختر وحدة محفظة لبدء التشغيل.", themeLight: "الوضع الفاتح", themeDark: "الوضع الداكن", identity: "الهوية", organizationSettings: "إعدادات المؤسسة", terminateSession: "إنهاء الجلسة", systemAccess: "دخول النظام", data: "البيانات", topics: "الموضوعات", goals: "الأهداف", review: "المراجعة", knowmore: "Knowmore", tactical: "تكتيكي", checklist: "Checklist", aiQueue: "طابور الذكاء الاصطناعي" },
  ...
  he: {
    ...
    nav: { company: "יחידת מודיעין", companyDescription: "יחידת תפעול", companySyncing: "מסנכרן...", selectPortfolio: "בחר יחידת פורטפוליו כדי להתחיל בפעילות.", themeLight: "מצב בהיר", themeDark: "מצב כהה", identity: "זהות", organizationSettings: "הגדרות ארגון", terminateSession: "סיום סשן", systemAccess: "גישת מערכת", data: "נתונים", topics: "נושאים", goals: "יעדים", review: "סקירה", knowmore: "Knowmore", tactical: "טקטי", checklist: "Checklist", aiQueue: "תור AI" },
