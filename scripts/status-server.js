...
async function buildStatusPayload() {
  ...
  return {
    ...
    activeEntityType: worker.currentEntityType || null,
    activeEntityLabel: worker.currentEntityLabel || null,
    activeCompany: worker.currentCompany || null,
    activeJobId: worker.currentJobId || null,
    activeJobType: worker.currentJobType || null,
    activeExecutionProfile: worker.currentExecutionProfile || null,
    activeExecutionResourceBand: worker.currentExecutionResourceBand || null,
    jobStartedAt: worker.jobStartedAt || null,
