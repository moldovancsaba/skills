...
assert(listRoute.includes("listMiniappResearchTasks"), "list route must read planner tasks");
...
assert(planRoute.includes("planMiniappResearchTasks"), "plan route must call planner");
