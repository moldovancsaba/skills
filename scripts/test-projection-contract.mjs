...
assert.match(snapshotWorker, /scanMiniappReviewPressureForDestination/, "snapshot worker should scan destination review packets for miniapp attention pressure");
