...
// We'll use a custom SVG for Google icon but wrapped in Mantine's Button icon section
const GoogleIcon = () => (
  ...
  return (
    <Center h="100vh">
      <Container size="xs" w="100%">
        <Stack gap="xl">
          <Box ta="center">
            <Title order={1} size={rem(48)} fw={900} lts={-2} mb="xs">
              checklist
            </Title>
            <Text c="dimmed" fw={600} tt="uppercase" lts={1} size="sm">
          ...
          {authError && (
            <Alert color="red" variant="light" radius="md">
              {authError === "sso_not_configured" 
                ? "SSO is not configured. Please contact system administrator."
          ...
          <Stack gap={4} align="center">
            <Text size="xs" c="dimmed" fw={700}>
              By proceeding, you acknowledge the system's protocols.
            </Text>
            <Box>
              <Anchor component={Link} href="/privacy" size="xs" fw={800} c="brand">PRIVACY</Anchor>
              <Text span mx="xs" c="dimmed" size="xs">·</Text>
              <Anchor component={Link} href="/terms" size="xs" fw={800} c="brand">TERMS</Anchor>
            </Box>
          </Stack>
        </Stack>
      </Container>
