...
export default async function ClassScoutVisitorOpsPage(
  { params }: { params: Promise<{ companyId: string }> },
) {
  const { companyId } = await params;
  const access = await requireUnitRouteAccess({
    companyId,
    requestPath: `/${companyId}/classscout/visitor-ops`,
  ...
  return <VisitorOpsWorkspace companyId={companyId} defaultVisitorKey="classscout" />;
}
