...
export const theme = createPublicBrandTheme({
  flatSurfaces: true,
  overrides: {
...
const gdsTelemetrySink: GdsTelemetrySink = (event) => {
  if (typeof window === "undefined") return;
  window.dispatchEvent(new CustomEvent("check:gds-ui-event", { detail: event }));
};
