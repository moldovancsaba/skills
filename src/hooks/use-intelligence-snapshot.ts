  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      setSnapshot({
        ...
        synthesisYield: data.state.synthesisYield || 0,
        confidenceAvg: data.state.confidenceAvg || 0,
        iceScoreAvg: data.state.iceScoreAvg || 0,
        easeScoreAvg: data.state.easeScoreAvg || 0,
