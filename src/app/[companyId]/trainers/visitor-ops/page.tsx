...
export default async function TrainersVisitorOpsPage(
  { params }: { params: Promise<{ companyId: string }> },
) {
  const { companyId } = await params;
  const access = await requireUnitRouteAccess({
    companyId,
    requestPath: `/${companyId}/trainers/visitor-ops`,
  ...
  return <VisitorOpsWorkspace companyId={companyId} defaultVisitorKey="trainers" />;
}
